...
$ sudo cp cloudera-manager-agent-5.15.0-1.cm5150.p0.62.el7.x86_64.rpm /var/www/html/cloudera-parcels/cdh5/5.15.0/
$ sudo cp cloudera-manager-daemons-5.15.0-1.cm5150.p0.62.el7.x86_64.rpm /var/www/html/cloudera-parcels/cdh5/5.15.0/
