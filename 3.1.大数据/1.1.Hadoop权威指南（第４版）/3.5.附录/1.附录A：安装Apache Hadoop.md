...
来检查守护进程是否成功启动，或通过`Web`界面：在 **`http://localhost:50070/`（hadoop3.0之前）
或 `http://localhost:9870/`（hadoop3.0之后）** 查看`namenode`、在 **`http://localhost:8088/`**
