...
您可以在Cloudera Manager中使用 **parcels** 或使用 **packages** 来安装Key Trustee Server。

#### 3.1.Navigator Key Trustee Server 5.14
...
从Package或Parcel下拉菜单中选择 **Packages**，选择您的操作系统版本，然后单击立即下载。
...
从Package或Parcel下拉菜单中选择 **Parcels**，选择您的操作系统版本，然后单击立即下载。
