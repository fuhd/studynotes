...
public class Test4 {
    ...
    public static void testAllocation() {
        ...
        /*
         * 因为Eden区域只有8M，allocation3的对象太大，Eden区放不下allocation3了，
         * 所以先做一次Minor GC，再把allocation3放入Eden区。这一次Minor GC中，
         * Survivor装不下allocation2这个对象，所以allocation2移到老年代，而allocation1
         * 只有256K，Survivor区域放得下，所以allocation1移入到了Survivor区域
         */
        allocation3 = new byte[4 * _1MB];
        allocation3 = null;
        /*
         * 这里触发第二次Minor GC，因为Eden区已经有了原来的allocation3对象，现在又
         * 创建了一个新的allocation3对象，共8M空间了，所以第二次Minor GC被触发，
         * 无根的原allocation3清理了，新allocation3放入到了Eden区，另外,Survivor区域中的
         * allocation1年龄到了，所以也进老年代了
         */
        allocation3 = new byte[4 * _1MB];
    }
